...
![](GMedHouseValue.png){fig-align="center" width="536"}

![](GMedIncome2009.png){fig-align="center" width="540"}

![](GYearBuilt.png){width="535"}
...
![Legend is still in progress. The darkest orange is "poor", lighter orange is "fair", and the blue is "good".](Slater_Sample_Gutter_Quality_Map.png){fig-align="center" width="548"}
