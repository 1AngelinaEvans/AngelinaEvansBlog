...
Kailyn and I (Angelina) focused on learning more about web scraping using R through the DataCamp Course called *Web Scraping in R*. We also began to follow steps for scraping the web using other tutorials.
...
-    When it comes to web scraping, we need to understand more than what the DataCamp course was teaching. It was a bit confusing.
